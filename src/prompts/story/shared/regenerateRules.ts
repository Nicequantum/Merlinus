 ...
 * "Add Tech Details" / audit coaching. Appended to the brand pack system prompt.
 *
 * This is NOT a from-scratch rewrite — it is surgical improvement of a draft.
 */
...
5. Do not invent codes, measurements, tests, or parts that are not in the current story, notes, diagnostics, or required corrections.
6. Prefer equal or higher completeness than the current story. A shorter, thinner story is a failure.
7. Use [NOT DOCUMENTED] only for steps still unsupported after applying corrections.
...
/** Fenced block of pending corrections for regenerate to apply surgically. */
